...
function PlayerForm({ navigation }) {
  const [char, setChar] = useState({ charClass: "", level: "", days: "" });
  return (
    <ScrollView>
      <View style={styles.wrapper}>
        <View style={styles.formRow}>
          <Picker
            ...
            selectedValue={char.charClass}
            onValueChange={(itemValue) =>
              setChar({ ...char, charClass: itemValue })
            }
          >
        ...
        <View style={styles.formRow}>
          <Picker
            style={styles.formPicker}
            selectedValue={char.level}
            onValueChange={(itemValue) =>
              setChar({ ...char, level: itemValue })
            }
          >
        ...
        <View style={styles.formRow}>
          <Picker
            style={styles.formPicker}
            selectedValue={char.days}
            onValueChange={(itemValue) => setChar({ ...char, days: itemValue })}
          >
        ...
        <View>
          <Button
            title="Roll Hustle"
            onPress={() =>
              navigation.navigate("RollHustle", {
